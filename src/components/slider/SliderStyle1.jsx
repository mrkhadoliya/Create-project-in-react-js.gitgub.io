                        ...
                        <div className="themesflat-container ">
                            <div className="wrap-heading flat-slider flex">
                                <div className="content"> 	
                                    <h1 className="heading mb-style"><span className="">Latest Blog On</span>                                          
                                    </h1>
                                    <h1 className="heading"><span className='fill'>3D Printing</span> </h1>
                                    <p className="sub-heading">Read all About 3D Printing in Details
                                    </p>
                                    <div className="flat-bt-slider flex style2">
                                        <Link to="/explore-01" className="sc-button header-slider style style-1 rocket fl-button pri-1"><span>Read
                                        </span></Link>
                                        <Link to="/create-item" className="sc-button header-slider style style-1 note fl-button pri-1"><span>Share
                                        </span></Link>
                                    </div>
                                </div>
                                <div className="image">
