                            ...
                            <div className="content-right">
                                <div className="sc-item-details">
                                    ...
                                    <div className="meta-item">
                                        <div className="left">
                                            <span className="viewed fa-solid fa-eye">&nbsp; 225</span>
                                            <span to="/login" className="liked fa-solid fa-thumbs-up wishlist-button mg-l-8">&nbsp;&nbsp; <span className="number-like"> 100</span></span>
                                            <span className="liked fa-solid fa-heart wishlist-button mg-l-8">&nbsp;&nbsp;&nbsp;<span className="number-like">100</span></span>
                                            <span className="liked fa-solid fa-comment wishlist-button mg-l-8">&nbsp;&nbsp;&nbsp;<span className="number-like">100</span></span>
                                        </div>
                                        <div className="right">
                                    ...
                                    <Link to="/wallet-connect" className="sc-button loadmore style bag fl-button pri-3"><span>Add To Cart</span></Link>
                                                            ...
                                                            <div className="client">
                                                                <div className="sc-author-box style-2">
                                                                    ...
                                                                    <div className="author-infor">
                                                                        <div className="name">
                                                                            <h6><Link to="/author-02">{item.name} </Link></h6> <span> Add to Cart</span>
                                                                        </div>
