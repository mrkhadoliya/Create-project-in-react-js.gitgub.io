                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="page-title-heading mg-bt-12">
                                <h1 className="heading text-center">Designers</h1>
                            </div>
                ...
                <div className="themesflat-container">
                    <div className="row">
                        ...
                        <div className="col-md-12 py-5">
                            <div className='bg-dark text-center rounde p-5'>
                                <h4 className='font-weight-normal text-center'>Advertisement</h4>
                            </div>
                        </div>
                    </div>
                </div>
