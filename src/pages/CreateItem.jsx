...
import ListingItemUpload from './ListingItemUpload';
                        ...
                        <div className="col-xl-9 col-lg-6 col-md-12 col-12">
                            ...
                            <div className="form-create-item">
                                ...
                                <div className="flat-tabs tab-create-item">
                                    ...
                                    <form action="#">
                                        <div className="row-form style-3 pb-4 px-0">
                                            <div className="inner-row-form col-12 col-md-6">
                                                <h4 className="title-create-item">Price</h4>
                                                <input type="text" placeholder="Enter price for one item (ETH)" /> 
                                            </div>
                                            <div className="inner-row-form col-12 col-md-6 style-2">
                                                <h4 className="title-create-item">Catergorie</h4>
                                                <div className="seclect-box p-0">
                                                    <div id="item-create" className="dropdown">
                                                        <Link to="#" className="btn-selector nolink">Abstraction</Link>
                                                        <ul >
                                                            <li><span>Art</span></li>
                                    ...
                                    <div className='mt-5'>
                                        <button className='sc-button style w-100 bag fl-button pri-3'>Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
